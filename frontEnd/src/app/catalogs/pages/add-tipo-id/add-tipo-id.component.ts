...
@Component({
    ...
    templateUrl: './add-tipo-id.component.html',
    styleUrls: ['./add-tipo-id.component.css'],
})
export class AddTipoIdComponent {
    ...
    crearTipoId(confirmed: boolean): void {
        this.showModal = false;
        if (confirmed) {
            this.cargando = true;

            this.collectionsService.addTipoId(this.formData).subscribe({
                next: (response) => {
                    this.cargando = false;
